...
import { X, Calendar as CalendarIcon, Clock, User, Phone, MapPin, Trash2, SendHorizontal, Bot, Mail, CheckCircle, Edit } from 'lucide-react';
            ...
            <div className="flex items-center justify-between p-2.5 bg-gray-50 rounded-xl">
              ...
              <div className="text-right">
                {(activeRole === 'super_admin' || activeRole === 'owner') && (
                  <span className="font-extrabold text-blue-600 text-sm block">RM {booking.amount || 0}</span>
                )}
              ...
              <>
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="px-3 py-2 text-red-600 hover:bg-red-50 rounded-xl font-medium flex items-center space-x-1.5 transition-colors border border-red-200"
                  >
                  ...
                  {onEditBooking && (
                    <button
                      ...
                      className="px-3 py-2 bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-300 rounded-xl font-bold flex items-center space-x-1.5 transition-colors"
                    >
                ...
                <button
                  ...
                  className="px-3.5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold flex items-center space-x-1.5 shadow-xs transition-colors"
                >
