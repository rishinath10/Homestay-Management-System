...
import { SendHorizontal, Mail, Settings, CheckCircle2, RefreshCw, Bot, Shield, Send, ChevronLeft, Menu } from 'lucide-react';
      ...
      <div className="hidden md:flex items-center justify-between py-3 px-4 bg-white border-b border-gray-250 shadow-2xs shrink-0">
        <div className="flex items-center space-x-3 shrink min-w-0">
          ...
          <h1 className="text-base font-bold text-gray-800 truncate flex items-center space-x-2">
            <SendHorizontal className="w-4.5 h-4.5 text-blue-650" />
            <span>Alerts & Notifications Log</span>
          </h1>
        </div>
        ...
        <div className="flex items-center space-x-2 shrink-0">
          <button
            ...
            className="p-1.5 text-gray-600 hover:bg-gray-150 rounded-full transition-colors shrink-0"
            title="Refresh Logs"
          >
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-2xs flex flex-col justify-between gap-4 md:hidden">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <SendHorizontal className="w-6 h-6 text-blue-650" />
            ...
            <div className="flex items-center space-x-2 w-full">
              <button
                onClick={onRefreshLogs}
                className="p-2 border border-gray-200 rounded-xl hover:bg-gray-55"
              >
                <RefreshCw className="w-4 h-4" />
              </button>
              <button
                onClick={() => setShowConfigModal(true)}
                className="flex-1 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold rounded-xl shadow-xs transition-colors flex items-center justify-center space-x-1"
              >
                <Settings className="w-4 h-4" />
                <span>Settings</span>
              </button>
