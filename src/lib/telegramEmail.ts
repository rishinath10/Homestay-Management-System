...
import { triggerNewBookingPushAlert } from './pushNotifications';
...
/**
 * Trigger combined Telegram + Email + PWA Web Push Alert for a booking
 */
export async function triggerTelegramAndEmailAlerts(
  ...
  await Promise.all([
    ...
    triggerNewBookingPushAlert(booking, staff)
  ]);
}
